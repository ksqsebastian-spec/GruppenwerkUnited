...
import { Loader2, Plus, Trash2, Star, StarOff, Car } from 'lucide-react';
...
export function AssignVehicleToDriver({
  driverId,
  driverName,
}: AssignVehicleToDriverProps): React.JSX.Element {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Weise {driverName} ein Fahrzeug zu</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{assignments?.length ?? 0} Fahrzeuge zugewiesen</CardDescription>
        </CardHeader>
        <CardContent>
