...
import { Loader2, Plus, Trash2, Star, StarOff, User } from 'lucide-react';
...
export function AssignDriverToVehicle({
  vehicleId,
  vehiclePlate,
}: AssignDriverToVehicleProps): React.JSX.Element {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Weise dem Fahrzeug {vehiclePlate} einen Fahrer zu</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{assignments?.length ?? 0} Fahrer zugewiesen</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {assignment.driver?.email && (
                        <p className="text-sm text-muted-foreground">{assignment.driver.email}</p>
                      )}
                    </div>
                    {assignment.is_primary && <Badge variant="default">Hauptfahrer</Badge>}
                  </div>
