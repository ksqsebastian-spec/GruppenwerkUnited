...
import type { QuickUvvCheckFormData } from '@/lib/validations/uvv-control';
...
interface BatchCheckFieldsProps {
  form: UseFormReturn<QuickUvvCheckFormData>;
  instructors: InstructorOption[] | undefined;
  intervalMonths: number;
  onCheckDateChange: (date: Date | undefined) => void;
}

/**
 * Gemeinsame Felder für die Sammel-Unterweisung (Datum, Unterweisender, Themen, Fälligkeit, Notizen).
 */
export function BatchCheckFields({
  form,
  instructors,
  intervalMonths,
  onCheckDateChange,
}: BatchCheckFieldsProps): React.JSX.Element {
  return (
    <>
      <FormField
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex flex-col">
            ...
            <FormDescription>
              Gilt für alle ausgewählten Fahrer ({intervalMonths} Monate nach Unterweisung)
            </FormDescription>
            <FormMessage />
          </FormItem>
        )}
