...
-- ============================================================================
-- VOB MONITOR – Ausschreibungsüberwachung (separates Schema)
-- ============================================================================

CREATE SCHEMA IF NOT EXISTS vob;

-- Unternehmen (VOB-Teilnehmer)
...
-- Wöchentliche Statistik pro Unternehmen
...
-- Trend-View mit Vorwochenvergleich
